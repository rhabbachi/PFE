...
Dans ce chapitre on a passé en revu les solutions choisies pour résoudre les problématiques posés par le projet ainsi que les outils et les techniques utilisés pour développer et tester notre application.