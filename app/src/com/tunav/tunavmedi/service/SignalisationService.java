...
public class SignalisationService extends Service {
    ...
    private final class SignalisationServiceHandler extends Handler {
	public SignalisationServiceHandler(Looper looper) {
	    super(looper);
	}
	...
	mServiceHandler = new SignalisationServiceHandler(mServiceLooper);
    }
