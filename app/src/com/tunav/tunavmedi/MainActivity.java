...
import com.tunav.tunavmedi.gui.NotImplemetedListFragment;
import com.tunav.tunavmedi.gui.TaskListFragment;
...
public class MainActivity extends Activity {
	...
	try {
		...
		actionBar.addTab(actionBar
			...
			.setTabListener(
				new TabListener<NotImplemetedListFragment>(this,
					TabEnum.MAIL.tag,
